...
export const columns = [
    ...
    {
        field: "refundInitiationAllowed",
        headerName: "refundInitiationAllowed",
        flex: 0.5, minWidth: 150, hide:true
    },
    {
        field: "paymentMethod",
    ...
    },
    {
        ...
        renderCell: (params) => (
            <button
                onClick={() => handleRefundButtonClick(params.row.id)}
                style={{
                    color: ! params.row.refundInitiationAllowed ? 'gray' : 'inherit',
                    backgroundColor: ! params.row.refundInitiationAllowed ? 'lightgray' : 'inherit',
                    cursor: ! params.row.refundInitiationAllowed ? 'not-allowed' : 'pointer',
                }}
                disabled={! params.row.refundInitiationAllowed}
            >Refund</button>
        ),
    },
];
...
const Refund = (paymentMethodCategory) => {
        ...
        <Box m="20px">
            ...
            >
                ...
                >
                    <StatBox
                        title={totalCount}
                        subtitle="#of successful settlement"
                    />
                </Box>
            </Box>
            <Box m="20px">
